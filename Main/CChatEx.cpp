...
char cChatButton_I3( int a1 )
{
	...
	for ( int i = 0 ; i < 4 ; i++ )
	{
		...
		switch ( i )
		{
			case 0:		wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3220));		break; // All
			case 1:		wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3221));		break; // Party
			case 2:		wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3222));		break; // Hội
			case 3:		wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3223));		break; // Gens
		}
	...
	ZeroMemory(ButtonText, sizeof(ButtonText));
	wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3224));
	...
	ZeroMemory(ButtonText, sizeof(ButtonText));
	wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3225));
	...
	ZeroMemory(ButtonText, sizeof(ButtonText));
	wsprintf(ButtonText, pGetTextLine(pTextLineThis, 3226));
...
bool CheckButtonAllChat(int x, int y, int Width, int Height)
{
	...
	return pCheckMouseOver(x, nY, nWidth, nHeight);
}
