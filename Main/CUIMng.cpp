...
{
	LoadBitmapA("SPK\\SPK_Bar.jpg", 31122, 0x2601, 0x2901, 1, 0);
	LoadBitmapA("SPK\\SPK_Loading.tga", 531123, 0x2601, 0x2901, 1, 0);
	LoadBitmapA("SPK\\SPK_BarFrame.tga", 531124, 0x2601, 0x2901, 1, 0);
	LoadBitmapA("SPK\\Left.jpg", 531122, 0x2600, 0x2900, 1, 0);
	LoadBitmapA("SPK\\Right.jpg", 531125, 0x2600, 0x2900, 1, 0);
}
...
void CUIMng::Load()
{
	...
	SetDword((DWORD)0x004D562C + 1, (DWORD)"SPK\\Nop\\none.tga");
}