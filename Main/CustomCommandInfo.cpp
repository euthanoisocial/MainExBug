...
void CCustomCommandInfo::DrawCommandWindow()
{
	...
	float MoveX = 20.0f;
	float MoveY = 30.0f;
	gCentral.gDrawWindowCustom(StartX, StartY, MainWidth , MainHeight + 20, eCommand_MAIN, gConfig.TSPK_TEXT_ENGINE[41]);
	...
	gInterface.DrawFormat(eGold,  StartX + 35,  StartBody + 46, 52, 1, gConfig.TSPK_TEXT_ENGINE[42]);
	gInterface.DrawFormat(eGold,  StartX + 125, StartBody + 46, 52, 1, gConfig.TSPK_TEXT_ENGINE[43]);
	gInterface.DrawFormat(eGold,  StartX + 210, StartBody + 46, 52, 1, gConfig.TSPK_TEXT_ENGINE[44]);
