...
{
	#if(BUNDLE_ITEM)
	if (BundleItem.IsBundleItem(ItemIndex))
	{
		return 1;
	}
	#endif
	if (ItemIndex == 7181 || ItemIndex == 7182)//DOan nay mo limit Bless,Soul
	{
		return 1;
	}
...
{	
	...
	if (TargetItemIndex > GET_ITEM(12, 6)
		&& (TargetItemIndex < GET_ITEM(12, 36)
		|| TargetItemIndex > GET_ITEM(12, 43))
		&& TargetItemIndex != GET_ITEM(12, 49)
		&& TargetItemIndex != GET_ITEM(12, 50)
		&& (TargetItemIndex < GET_ITEM(12, 262)
		|| TargetItemIndex > GET_ITEM(12, 265))
		&& TargetItemIndex != GET_ITEM(13, 30)
		&& (TargetItemIndex < GET_ITEM(13, 20)
		|| TargetItemIndex > GET_ITEM(13, 28))
		&& TargetItemIndex != GET_ITEM(13, 8)
		&& TargetItemIndex != GET_ITEM(13, 9)
		&& TargetItemIndex != GET_ITEM(13, 12)
		&& TargetItemIndex != GET_ITEM(13, 13)
