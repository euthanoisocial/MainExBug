...
void CCustomJewelBank::DrawJewelBankWindow()
{
	...
	if (gInterface.IsWorkZone(eJewelBank_CLOSE))
	{
		...
		gInterface.DrawToolTip((int)gInterface.Data[eJewelBank_CLOSE].X + 5, (int)gInterface.Data[eJewelBank_CLOSE].Y + 25, gConfig.TSPK_TEXT_ENGINE[26]);
	}

	gInterface.DrawFormat(eGold, (int)StartX + 10, (int)StartBody + 10, 210, 3, gConfig.TSPK_TEXT_ENGINE[47]);
	...
	if (this->JewelEnable == 1)
	{
		...
		RenderBitmap(32344, StartX + MainWidth - gInterface.Data[eSAMPLEBUTTON].Width - 130 + MoveLeft, 313 + MoveDown, 50.f, 18.f, 0, 0, 80.f / 128.f, 30.f / 34.f, 1, 1, 0.0);
		
		gToolKit.RenderExNumberLevel2(StartX + MainWidth - gInterface.Data[eSAMPLEBUTTON].Width - 110 + MoveLeft, 318 + MoveDown, this->Page + 1, this->MAX_PAGES,0.77);

		gInterface.DrawGUI(eJewelBank_NEXT, StartX + MainWidth - gInterface.Data[eSAMPLEBUTTON].Width - 80 + MoveLeft, 310 + MoveDown);
		gInterface.DrawGUI(eJewelBank_PREV, StartX + MainWidth - gInterface.Data[eSAMPLEBUTTON].Width - 150 + MoveLeft, 310 + MoveDown);
		...
		for (int i = (MAX_ITEM_BANK * this->Page); i < (MAX_ITEM_BANK * this->Page) + MAX_ITEM_BANK; i++)
		{
			...
			switch (i)
			{
				case 0:	 DrawItemText(StartX,StartBody, 0,  posyy, this->PosItemBank[0],   this->m_Data.ItemBank[0], 14, 13 ,0, gConfig.TSPK_TEXT_ENGINE[48], 7);break;
				case 1:	 DrawItemText(StartX,StartBody, 4,  posyy, this->PosItemBank[1],   this->m_Data.ItemBank[1], 14, 14 ,0, gConfig.TSPK_TEXT_ENGINE[49], 11);break;
				case 2:	 DrawItemText(StartX,StartBody, 8,  posyy, this->PosItemBank[2],   this->m_Data.ItemBank[2], 14, 16 ,0, gConfig.TSPK_TEXT_ENGINE[50], 15);break;
				case 3:	 DrawItemText(StartX,StartBody, 12, posyy, this->PosItemBank[3],   this->m_Data.ItemBank[3], 14, 22 ,0, gConfig.TSPK_TEXT_ENGINE[51], 19);break;
				case 4:	 DrawItemText(StartX,StartBody, 16, posyy, this->PosItemBank[4],   this->m_Data.ItemBank[4], 14, 31 ,0, gConfig.TSPK_TEXT_ENGINE[52], 23);break;
				case 5:	 DrawItemText(StartX,StartBody, 20, posyy, this->PosItemBank[5],   this->m_Data.ItemBank[5], 14, 41 ,0, gConfig.TSPK_TEXT_ENGINE[53], 27);break;
				case 6:	 DrawItemText(StartX,StartBody, 24, posyy, this->PosItemBank[6],   this->m_Data.ItemBank[6], 14, 42 ,0, gConfig.TSPK_TEXT_ENGINE[54], 31);break;
				case 7:	 DrawItemText(StartX,StartBody, 28, posyy, this->PosItemBank[7],   this->m_Data.ItemBank[7], 12, 15 ,0, gConfig.TSPK_TEXT_ENGINE[55], 35);break;
				case 8:	 DrawItemText(StartX,StartBody, 32, posyy, this->PosItemBank[8],   this->m_Data.ItemBank[8], 14, 43 ,0, gConfig.TSPK_TEXT_ENGINE[56], 39);break;
				case 9:	 DrawItemText(StartX,StartBody, 36, posyy, this->PosItemBank[9],   this->m_Data.ItemBank[9], 14, 44 ,0, gConfig.TSPK_TEXT_ENGINE[57], 43);break;
				case 10: DrawItemText(StartX,StartBody, 0,  posyy, this->PosItemBank[10],  this->m_Data.ItemBank[10],14, 244,0, gConfig.TSPK_TEXT_ENGINE[58], 7);break;
				case 11: DrawItemText(StartX,StartBody, 4,  posyy, this->PosItemBank[11],  this->m_Data.ItemBank[11],14, 245,0, gConfig.TSPK_TEXT_ENGINE[59], 11);break;
				case 12: DrawItemText(StartX,StartBody, 8,  posyy, this->PosItemBank[12],  this->m_Data.ItemBank[12],14, 246,0, gConfig.TSPK_TEXT_ENGINE[60], 15);break;
				case 13: DrawItemText(StartX,StartBody, 12, posyy, this->PosItemBank[13],  this->m_Data.ItemBank[13],14, 247,0, gConfig.TSPK_TEXT_ENGINE[61], 19);break;
				case 14: DrawItemText(StartX,StartBody, 16, posyy, this->PosItemBank[14],  this->m_Data.ItemBank[14],14, 248,0, gConfig.TSPK_TEXT_ENGINE[62], 23);break;
				case 15: DrawItemText(StartX,StartBody, 20, posyy, this->PosItemBank[15],  this->m_Data.ItemBank[15],14, 249,0, gConfig.TSPK_TEXT_ENGINE[63], 27);break;
				case 16: DrawItemText(StartX,StartBody, 24, posyy, this->PosItemBank[16],  this->m_Data.ItemBank[16],14, 250,0, gConfig.TSPK_TEXT_ENGINE[64], 31);break;
				case 17: DrawItemText(StartX,StartBody, 28, posyy, this->PosItemBank[17],  this->m_Data.ItemBank[17],14, 251,0, gConfig.TSPK_TEXT_ENGINE[65], 35);break;
				case 18: DrawItemText(StartX,StartBody, 32, posyy, this->PosItemBank[18],  this->m_Data.ItemBank[18],14, 252,0, gConfig.TSPK_TEXT_ENGINE[66], 39);break;
				case 19: DrawItemText(StartX,StartBody, 36, posyy, this->PosItemBank[19],  this->m_Data.ItemBank[19],14, 260,0, gConfig.TSPK_TEXT_ENGINE[67], 43);break;
				case 20: DrawItemText(StartX,StartBody, 0,   posyy, this->PosItemBank[20], this->m_Data.ItemBank[20],12, 32 ,0, "Hộp Quà Đỏ",				  7);  break;
				case 21: DrawItemText(StartX,StartBody, 4,   posyy, this->PosItemBank[21], this->m_Data.ItemBank[21],12, 33 ,0, "Hộp Quà Xanh Lá",			  11); break;
				case 22: DrawItemText(StartX,StartBody, 8,   posyy, this->PosItemBank[22], this->m_Data.ItemBank[22],12, 34 ,0, "Hộp Quà Xanh Dương",		  15); break;
				case 23: DrawItemText(StartX,StartBody, 12,  posyy, this->PosItemBank[23], this->m_Data.ItemBank[23],14, 52 ,0, "Box GM",					  19); break;
				case 24: DrawItemText(StartX,StartBody, 16,  posyy, this->PosItemBank[24], this->m_Data.ItemBank[24],14, 55 ,0, "Box Trang Bị 380",		  23); break;
				case 25: DrawItemText(StartX,StartBody, 20,  posyy, this->PosItemBank[25], this->m_Data.ItemBank[25],14, 56 ,0, "Box Vũ Khí Cấp 4",		  27); break;
				case 26: DrawItemText(StartX,StartBody, 24,  posyy, this->PosItemBank[26], this->m_Data.ItemBank[26],14, 57 ,0, "Box Khiên Cấp 4",			  31); break;
				case 27: DrawItemText(StartX,StartBody, 28,  posyy, this->PosItemBank[27], this->m_Data.ItemBank[27],14, 51 ,0, "Pháo Hoa Ngôi Sao",		  35); break;
				case 28: DrawItemText(StartX,StartBody, 32,  posyy, this->PosItemBank[28], this->m_Data.ItemBank[28],14, 121,0, "Hộp Quà Vàng",			  39); break;
				case 29: DrawItemText(StartX,StartBody, 36,  posyy, this->PosItemBank[29], this->m_Data.ItemBank[29],14, 122,0, "Hộp Quà Bạc",				  43); break;
			}
			if (i < 10 || i >= 10 && i < 20 || i >= 20 && i < 30)
			{
				for (int j = (i * 5); j < (i * 5) + 5; j++)
				{
					...
					if (posxx == 0) gToolKit.CRenderNumberClassic(1, StartX + 128 + (18 *  posxx), StartBody + 59 + (22 * posyy), 1, 0.72);
					if (posxx == 1) gToolKit.CRenderNumberClassic(1, StartX + 128 + (18 *  posxx), StartBody + 59 + (22 * posyy), 1 * 10, 0.72);
					if (posxx == 2) gToolKit.CRenderNumberClassic(1, StartX + 128 + (18 *  posxx), StartBody + 59 + (22 * posyy), 1 * 20, 0.72);
					if (posxx == 3) gToolKit.CRenderNumberClassic(1, StartX + 128 + (18 *  posxx), StartBody + 59 + (22 * posyy), 1 * 30, 0.72);
					if (posxx == 4) gToolKit.CRenderNumberClassic(1, StartX + 128 + (18 *  posxx), StartBody + 59 + (22 * posyy), this->JewelMaxCount, 0.72);
					posxx++;
				}
			}
		}
		gInterface.DrawFormat(eExcellent, StartX, StartBody + 280, 230, 3, gConfig.TSPK_TEXT_ENGINE[68]);
	}
	else
	{
		gInterface.DrawFormat(eGold, MainCenter + 30, StartBody + 100, 52, 1, gConfig.TSPK_TEXT_ENGINE[69]);
	}
}
