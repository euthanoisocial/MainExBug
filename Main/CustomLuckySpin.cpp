...
void CLuckySpin::Draw()
{
	...
	gInterface.DrawFormat(eYellow, 300, 222, 210, 3, gConfig.TSPK_TEXT_ENGINE[70], this->WCoinC); // "Giá"
	gInterface.DrawFormat(eYellow, 300, 249, 210, 3, gConfig.TSPK_TEXT_ENGINE[71]); // "Quay"
}
