...
void hook_sub_790B50(int a1, float a2, float a3, float a4, float a5)
{
	...
	gInterface.DrawFormat(-1, 450 + 64 , 400, 64, 3, gConfig.TSPK_TEXT_ENGINE[72]);
}
bool CheckNPCShop()
{
...
bool cGuildUpgrade::Draw()
{
	...
	gInterface.DrawFormat(-1, x, y + 12, w, 3, gConfig.TSPK_TEXT_ENGINE[73]);
	...
	gInterface.DrawFormat(-1, x + 14, y + 40, 73, 3, gConfig.TSPK_TEXT_ENGINE[74]);
	gInterface.DrawFormat(-1, x + 14 + 75 * 1, y + 40, 73, 3, gConfig.TSPK_TEXT_ENGINE[75]);
	gInterface.DrawFormat(-1, x + 14 + 75 * 2, y + 40, 73, 3, gConfig.TSPK_TEXT_ENGINE[76]);
	gInterface.DrawFormat(-1, x + 14 + 75 * 3, y + 40, 73, 3, gConfig.TSPK_TEXT_ENGINE[77]);
	gInterface.DrawFormat(-1, x + 14 + 75 * 4, y + 40, 73, 3, gConfig.TSPK_TEXT_ENGINE[78]);
...
{
	CustomFont.Draw(CustomFont.FontBold,   x + 25, y + 70, 0xffff00ff, 0x0, w - 50, 20, 3,  gConfig.TSPK_TEXT_ENGINE[79]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 90, 0xffffffff, 0x0, w - 50, 15, 1,  gConfig.TSPK_TEXT_ENGINE[80]);
	CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 100, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[81]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 110, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[82]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 120, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[83]);
	CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 130, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[84]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 140, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[85]);
	CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 150, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[86]);
	CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 160, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[87]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 170, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[88]);
    CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 180, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[89]);
	CustomFont.Draw(CustomFont.FontNormal, x + 25, y + 190, 0xffffffff, 0x0, w - 50, 15, 1, gConfig.TSPK_TEXT_ENGINE[90]);
}
void cGuildUpgrade::DrawRankingInfo()
{
	int i, j;
	char* text[5] = { "#", gConfig.TSPK_TEXT_ENGINE[91], gConfig.TSPK_TEXT_ENGINE[92], gConfig.TSPK_TEXT_ENGINE[93], gConfig.TSPK_TEXT_ENGINE[94]};
	for (i = 0; i < 5; i ++)
	...
	else
	{
		...
		CustomFont.Draw(CustomFont.FontBold, x + 135 + 50, y + h - 20, 0xffffffff, 0x0, 50, 0, 3, gConfig.TSPK_TEXT_ENGINE[105], this->CurPage, this->TotalPages);
...
{
	int i, j;
	char* text[5] = { "#", gConfig.TSPK_TEXT_ENGINE[95], gConfig.TSPK_TEXT_ENGINE[96], gConfig.TSPK_TEXT_ENGINE[97], gConfig.TSPK_TEXT_ENGINE[98] };
	for (i = 0; i < 4; i++)
	...
	if (this->LoadedMyGuild == false) {
		...
		GuildUpgrade.DrawButton(32345, x + 120 + 50, y + h - 24, 20, 22, 32.f, 128.f, GuildUpgrade.PagePrevAction, 15, 16);
		GuildUpgrade.DrawButton(32346, x + 185 + 50, y + h - 24, 20, 22, 32.f, 128.f, GuildUpgrade.PageNextAction, 15, 16);
		CustomFont.Draw(CustomFont.FontNormal, x + 30 + 60 * 4, y + 85, 0xffffffff, 0x0, 110, 0, 3, gConfig.TSPK_TEXT_ENGINE[104], this->myGuildMemberInfo.Level);
		CustomFont.Draw(CustomFont.FontNormal, x + 30 + 60 * 4, y + 100, 0xffffffff, 0x22ff2220, 110, 0, 3, gConfig.TSPK_TEXT_ENGINE[105], this->myGuildMemberInfo.TotalDevote, this->myGuildMemberInfo.NextDevote);
	}
}
void cGuildUpgrade::DrawDevoteInfo()
{
	int i, j;
	CustomFont.Draw(CustomFont.FontNormal, x + 20, y + 70, 0xffffffff, 0xff222299, 110, 0, 3, gConfig.TSPK_TEXT_ENGINE[99]);

	CustomFont.Draw(CustomFont.FontNormal, x + 140, y + 70, 0xffffffff, 0xff222299, 50, 0, 3, gConfig.TSPK_TEXT_ENGINE[100]);
	...
	if (this->LoadedDevoteItems == false) {
		...
		CustomFont.Draw(CustomFont.FontNormal, x + 250, y + 75, 0xffffffff, 0xff222299, 90, 0, 3, gConfig.TSPK_TEXT_ENGINE[101]);
		...
		CustomFont.Draw(CustomFont.FontNormal, x + 208, y + 185, 0xffffffff, 0x0, 180, 0, 3, gConfig.TSPK_TEXT_ENGINE[102], gToolKit.NumberFormat(this->CurDevotePrice));


		GuildUpgrade.DrawButton(32331, x + 272.5, y + 200, 73, 27, 128.0, 128.0, GuildUpgrade.DevoteAction, 50, 23);

		CustomFont.Draw(CustomFont.FontNormal, x + 208, y + 222.5 - 15, 0xffffffff, 0x0, 180, 0, 3, gConfig.TSPK_TEXT_ENGINE[97]);

		RenderBitmap(31395, x + w - 118, y + h - 24, 100.f, 16.f, 0, 0, 170.f / 256.f, 21.f / 32.f, 1, 1, 0.0);
		CustomFont.Draw(CustomFont.FontNormal, x + w - 115, y + h - 21, 0xffffffff, 0x0, 40, 0, 3, gConfig.TSPK_TEXT_ENGINE[97]);
...
void cGuildUpgrade::DrawShopInfo()
{
	...
	CustomFont.Draw(CustomFont.FontNormal, x + 45, y + 70, 0xffffffff, 0xff222299, 50,  0, 3, gConfig.TSPK_TEXT_ENGINE[99]);
	CustomFont.Draw(CustomFont.FontNormal, x + 190, y + 70, 0xffffffff, 0xff222299, 35, 0, 3, gConfig.TSPK_TEXT_ENGINE[94]);
	CustomFont.Draw(CustomFont.FontNormal, x + 270, y + 70, 0xffffffff, 0xff222299, 70, 0, 3, gConfig.TSPK_TEXT_ENGINE[93]);
	if (this->LoadedShopItems == false) {
		char buf[25];
		int step = GetTickCount() / 1000 % 4;
		sprintf(buf, "Loading data%%.%ds", step);
		...
		for (i = 0; i < m; i++)
		{
			...
			if (this->MeGuildLevel >= this->ShopItems[i + (this->CurPage - 1) * GU_ROW_PER_PAGE].GuildLevel &&
				...
				CustomFont.Draw(CustomFont.FontNormal, x + 350, y + 83 + 15 * i, 0xffffffff, 0x0, 30, 0, 3, gConfig.TSPK_TEXT_ENGINE[103]);
			}
