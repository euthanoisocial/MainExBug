...
void Interface::DrawMiniMapTron()
{
	...
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[108]);
		if( *(BYTE*)0x8793386 )
		{
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[109]);
		if( *(BYTE*)0x8793386 )
		{
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[27]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[30]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[31]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[28]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[110]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[18]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
	...
	if(pCheckMouseOver( x1, y1, w1, h1 ))
	{
		this->DrawToolTip(v11 + 26, v10 - 20, gConfig.TSPK_TEXT_ENGINE[32]);
		if( *(BYTE*)0x8793386 )
		{
			PlayBuffer(25, 0, 0);
