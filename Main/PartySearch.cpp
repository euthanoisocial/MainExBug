...
void cPartySearch::DrawPartySettingsWindow(){
	...
	if (gInterface.IsWorkZone(ePARTYSETTINGS_CLOSE)){
		...
		gInterface.DrawToolTip(gInterface.Data[ePARTYSETTINGS_CLOSE].X + 5, gInterface.Data[ePARTYSETTINGS_CLOSE].Y + 25, gConfig.TSPK_TEXT_ENGINE[26]);
	}
	gInterface.DrawFormat(eGold, StartX + 10, 60, 210, 3, gConfig.TSPK_TEXT_ENGINE[114]);
	gInterface.DrawFormat(eWhite, StartX + 40, gInterface.Data[ePARTYSETTINGS_MAIN].Y + 33, 200, 1, gConfig.TSPK_TEXT_ENGINE[115]);
	...
	gInterface.DrawFormat(eWhite, StartX + 40, gInterface.Data[ePARTYSETTINGS_MAIN].Y + 60, 200, 1, gConfig.TSPK_TEXT_ENGINE[116]);
	...
	gInterface.DrawFormat(eWhite, StartX + 40, gInterface.Data[ePARTYSETTINGS_MAIN].Y + 87, 200, 1, gConfig.TSPK_TEXT_ENGINE[117]);
	...
	gInterface.DrawFormat(eWhite, StartX + 40, gInterface.Data[ePARTYSETTINGS_MAIN].Y + 109, 200, 1, gConfig.TSPK_TEXT_ENGINE[118]);
	if (gPartySearchSettings.m_SystemActive){
...
void cPartySearch::DrawPartySearchWindow(){
	...
	if (gInterface.IsWorkZone(ePARTYSEARCH_CLOSE)){
		...
		gInterface.DrawToolTip(gInterface.Data[ePARTYSEARCH_CLOSE].X + 5, gInterface.Data[ePARTYSEARCH_CLOSE].Y + 25, gConfig.TSPK_TEXT_ENGINE[26]);
	}
	gInterface.DrawFormat(eGold, StartX + 10, 60, 210, 3, gConfig.TSPK_TEXT_ENGINE[126]);
	int x = 200;
	int y = 50;
	gInterface.DrawFormat(eWhite, StartX + 20, gInterface.Data[ePARTYSEARCH_MAIN].Y + 34, 80, 1, gConfig.TSPK_TEXT_ENGINE[127]);
	if (gPartySearchSettings.m_SystemActive == false){
	...
	gInterface.DrawFormat(eWhite, StartX + 5, gInterface.Data[ePARTYSEARCH_MAIN].Y + 56, 50, 3, gConfig.TSPK_TEXT_ENGINE[128]);
	...
	if (gPartySearch.CountPages>1){
		gInterface.DrawFormat(eGold, StartX + 104, 379, 20, 3, gConfig.TSPK_TEXT_ENGINE[105], gPartySearch.Page + 1, gPartySearch.CountPages);
	}
