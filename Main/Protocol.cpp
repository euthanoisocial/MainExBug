...
BOOL ProtocolCoreEx(BYTE head,BYTE* lpMsg,int size,int key) // OK
{
	...
	if (ProtocolType == 0xC1)
	{
		...
		if (error)
		{
			MessageBoxW(NULL, L"Phát hiện có bất thường. Vui lòng khởi động lại game!", L"SuperKhung", MB_OK | MB_ICONERROR);ExitProcess(0);
			ExitProcess(0);
		}
	}
	...
	switch(head)
	{
		...
		switch (((lpMsg[0] == 0xC1) ? lpMsg[3] : lpMsg[4]))
		{
			...
			case 0x0F: g_pMyInventory.ReceiveItemChange(lpMsg);	return 1;
			#endif
		...
		switch(((lpMsg[0]==0xC1)?lpMsg[3]:lpMsg[4]))
		{
			...
			#endif
			#if RELIFE
			case 107: G_SpkRelife.TaiSinhCheckRecv((RelifeCheckUpdate*)lpMsg);			break;
			case 108: G_SpkRelife.TaiSinhDiemRecv((RelifePointUpdate*)lpMsg);			break;
			case 109: G_SpkRelife.SaveFormGs((RelifeCheckReqInfoPart1*)lpMsg);			break;
			#endif
		}
		break;
		...
		switch (((lpMsg[0] == 0xC1) ? lpMsg[3] : lpMsg[4]))
		{
			...
			case 0x2B:
			{
				...
				gCustomHarmony.SoLuongDaTaoHoa = mRecv->SoLuongDaTaoHoa;
				gCustomHarmony.IndexRandom = mRecv->IndexRandom;

			}
			break;
			case 0x25:	gCustomHarmony.RecvHarmony((CHCSEV_COUNTLIST*)lpMsg);		break;
			#if(SPK_HONHOAN)
		...
		switch (((lpMsg[0] == 0xC1) ? lpMsg[3] : lpMsg[4]))
		{
			...
			case 0xE6:	GITEM00.SendData((GS_ITEM00*)lpMsg);					break;
			case 0xE7:	GITEM06.SendData((GS_ITEM06*)lpMsg);					break;
			case 0xE8:	GITEM07.SendData((GS_ITEM07*)lpMsg);					break;
			case 0xE9:	GITEM08.SendData((GS_ITEM08*)lpMsg);					break;
			case 0xEA:	GITEM09.SendData((GS_ITEM09*)lpMsg);					break;
			case 0xEB:	GITEM10.SendData((GS_ITEM10*)lpMsg);					break;
			case 0xEC:	GITEM11.SendData((GS_ITEM11*)lpMsg);					break;
			case 0xED:	GITEM12.SendData((GS_ITEM12*)lpMsg);					break;
			case 0xEE:	GITEM13.SendData((GS_ITEM13*)lpMsg);					break;
		}
		break;
		//add News , tue
		case 0xFD:
			pDrawMessage("case 0xFD: rect",1);
			gNewsBoard.OpenMain((NEWS_ANS_TITLES*)lpMsg);
			//gCustomNoticeInfo.OpenNoticeWindow();
			break;

		case 0xFE:
			pDrawMessage("case 0xFE: rect", 1);
		...
		case 0x05:	gRanking.RecvInfoNap((DGCharTopNap*)lpMsg);							break;
		...
		case 0x09:	gRanking.RecvInfoDW((DGCharTopDW*)lpMsg);							break;
		case 0x0A:	gRanking.RecvInfoDK((DGCharTopDK*)lpMsg);							break;
		case 0x0B:	gRanking.RecvInfoEF((DGCharTopEF*)lpMsg);							break;
		case 0x0C:	gRanking.RecvInfoMG((DGCharTopMG*)lpMsg);							break;
		case 0x0E:	gRanking.RecvInfoDL((DGCharTopDL*)lpMsg);							break;
		case 0x0F:	gRanking.RecvInfoSM((DGCharTopSM*)lpMsg);							break;
		case 0x10:	gRanking.RecvInfoRF((DGCharTopRF*)lpMsg);							break;
	}
