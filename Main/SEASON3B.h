...
#define IsVisible									((bool(__thiscall*)(int thisa, int Code)) 0x0085EC20)
...
#define WindowWidth1									*(GLsizei*)0x00E61E58
#define WindowHeight1								*(GLsizei*)0x00E61E5C

char* GlobalText2(int iNum, bool custom = false);
