...
#include "Util.h"
#include "Config.h"
SPKTaiKhoan gTaiKhoan;

void SPKTaiKhoan::DrawVoidDoiPass()
{
	WindowsChangePass();
}

void SPKTaiKhoan::BinObeject()
{
...
bool SPKTaiKhoan::EventClickChangePass(DWORD Event)
{
...
bool SPKTaiKhoan::TextBoxChangePass(DWORD Event)
{
...
void SPKTaiKhoan::WindowsChangePass()
{
	if (CheckSPK_WINDOWS)
	{
	...
	gCentral.gDrawWindowCustomXClose(StartX, StartY, CuaSoW, CuaSoH, eChangePass_Main, gConfig.TSPK_TEXT_ENGINE[304]);
	...
	gInterface.SPKText(eWhite, StartX + 25 , StartY + StepY + 5, 170, 1, gConfig.TSPK_TEXT_ENGINE[305]);
	gInterface.SPKText(eWhite, StartX + 100 , StartY + StepY + 5, 100, 1, gInterface.Data[eChangePass_OLD_HIDE].StatValue);
	...
	gInterface.SPKText(eWhite,  StartX + 25 , StartY + StepY + 5, 170, 1, gConfig.TSPK_TEXT_ENGINE[306]);
	gInterface.SPKText(eWhite,  StartX + 100 , StartY + StepY + 5, 100, 1, gInterface.Data[eChangePass_NEW_HIDE].StatValue);
	...
	gInterface.SPKText(eWhite, StartX + 25, StartY + StepY + 5, 170, 1, gConfig.TSPK_TEXT_ENGINE[307]);
	gInterface.SPKText(eWhite, StartX + 100, StartY + StepY + 5, 100, 1, gInterface.Data[eChangePass_NEW_HIDE1].StatValue);
