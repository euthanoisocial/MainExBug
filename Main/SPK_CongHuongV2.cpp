...
void CongHuongV2New::DrawWindowCongHuong()
{
	...
	pSetBlend(true);
	gCentral.gDrawWindowCustom(StartX - 5, StartY, CuaSoW, CuaSoH, eWindow_CongHuong, gConfig.TSPK_TEXT_ENGINE[193]);

	gCentral.gInfoBox(StartX + 7, StartY + 35, 170, 130, 0x00000096, 0, 0);
	CustomFont.Draw(CustomFont.FontNormal, StartX + 7, StartY + 39, 0xFFFFFFFF, 0x0, 170, 0, 3, gConfig.TSPK_TEXT_ENGINE[194]);
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX + 12, StartY + 55 + (21 * 4), 0xFFFFFFFF, 0x0, 45, 0, 3, gConfig.TSPK_TEXT_ENGINE[195]);
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX + 12 + 50, StartY + 55 + (21 * 4), 0xFFFFFFFF, 0x0, 45, 0, 3, gConfig.TSPK_TEXT_ENGINE[196]);
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX + 12 + 50 + 45 + 20, StartY + 55 + (21 * 4), 0xFFFFFFFF, 0x0, 45, 0, 3, gConfig.TSPK_TEXT_ENGINE[197]);
	...
	CustomFont.Draw(CustomFont.FontBold, StartX + 195, StartY + 40, 0xFFBA19FF, 0x0, 90, 0, 1, gConfig.TSPK_TEXT_ENGINE[198]);
	...
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 195, StartY + 55 + (13 * CountItem), 0xDE1616FF, 0x0, 120, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]); //
	}
	float flScrollDiv = 0;
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX + 15, StartY + 180, 0xFFFFFFFF, 0x0, (170 / 2), 0, 1, gConfig.TSPK_TEXT_ENGINE[200]);
	if (this->CH_TyLeThanhCong == -1)
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180, 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]);
	}
	else
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180, 0x19FF9FFF, 0x0, 0, 0, 1, "%d %%", this->CH_TyLeThanhCong);
	}
	CustomFont.Draw(CustomFont.FontNormal, StartX + 15, StartY + 180 + 13, 0xFFFFFFFF, 0x0, (170 / 2), 0, 1, gConfig.TSPK_TEXT_ENGINE[202]);
	if (this->CH_ResetMix == -1)
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180 + 13, 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]);
	}
	else
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180 + 13, 0x19FF9FFF, 0x0, 0, 0, 1, "%d (RS)", this->CH_ResetMix);
	}
	CustomFont.Draw(CustomFont.FontNormal, StartX + 15, StartY + 180 + 26, 0xFFFFFFFF, 0x0, (170 / 2), 0, 1, gConfig.TSPK_TEXT_ENGINE[204]);
	if (this->CH_TypeMix == -1)
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180 + 26, 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]);
	}
	else
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 180 + 26, 0x19FF9FFF, 0x0, 0, 0, 1, "%s", "");
	}
	CustomFont.Draw(CustomFont.FontNormal, StartX + 15, StartY + 225, 0xFFFFFFFF, 0x0, (170 / 2), 0, 1, gConfig.TSPK_TEXT_ENGINE[201]);
	CustomFont.Draw(CustomFont.FontNormal, StartX + 15, StartY + 225 + 13, 0xFFBA19FF, 0x0, (170 / 2), 0, 1, "WC: ");
	if (this->CH_CoinMix[0] == -1)
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 225 + 13, 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]);
	}
	else {
	...
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 225 + (13 * 2), 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]);
	}
	else {
	...
	{
		CustomFont.Draw(CustomFont.FontNormal, StartX + 20 + (170 / 2), StartY + 225 + (13 * 3), 0xDE1616FF, 0x0, 0, 0, 1, gConfig.TSPK_TEXT_ENGINE[199]); //
	}
	else {
	...
	if (pCheckMouseOver(StartX + 7 + (170 / 2) - 15, StartY + 55 + 140 + 100, 44.0, 35.0) == 1 && this->CH_IndexItem[2] != -1)
	{
		...
		gInterface.DrawToolTip(gObjUser.m_CursorX + 20, gObjUser.m_CursorY, gConfig.TSPK_TEXT_ENGINE[203]);
	}
	if (this->CH_EffectMixOn)
	{
		RenderMixEffect(this->CH_EffectMixOn, StartX + 12 + 50 + 45 + 20, StartY + 55);
	}
	JCCoord B;
