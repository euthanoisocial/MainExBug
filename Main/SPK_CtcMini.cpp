...
void CtcMiniClass::DrawCTCMiniWindow()
{
	...
	if (pCheckMouseOver(CloseX, CloseY - StartYMove, 36, 36) == 1)
	{
		...
		gInterface.DrawFormat(eGold, CloseX + 15, CloseY + 30 - StartYMove, 0, 1, gConfig.TSPK_TEXT_ENGINE[26]);
	}
	gInterface.DrawFormat(eGold, StartX + 10, gInterface.Data[CTCMINI_MAIN].Y + 8, 210, 3, gConfig.TSPK_TEXT_ENGINE[205]);
	gInterface.DrawFormat(eBlue, StartX + 10, gInterface.Data[CTCMINI_MAIN].Y + 30, 210, 3, gConfig.TSPK_TEXT_ENGINE[206], gObjUser.lpPlayer->Name);
	gInterface.DrawAnimatedGUI(CTCMINI_DIV, StartX, gInterface.Data[CTCMINI_MAIN].Y + 33);

	StartY = StartY + 45;
	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10), StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[207]); //
	StartY = StartY + 12;
	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10), StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[208]); //
	StartY = StartY + 12;
	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10), StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[209]); //
	StartY = StartY + 12;
	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10), StartY - StartYMove, 0x00FFCCFF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[210]); //
	StartY = StartY + 12;
	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10), StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[211]); //
	StartY = StartY + 25;
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + (SizeButtonH / 4) - StartYMove, 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[212]); //Buoc Vao
	StartY = StartY + 22;
	if (pCheckMouseOver(StartX, StartY - StartYMove, SizeButtonW, SizeButtonH) == 1)
	{
		glColor3f(1.0f, 0.6742f, 0.15f);
	...
	RenderBitmap(31563, StartX, StartY - StartYMove, SizeButtonW, SizeButtonH, 0.0, 0.0, 0.64999998, 0.80000001, 1, 1, 0);
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + (SizeButtonH / 4) - StartYMove, 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[213]); //Buoc Vao
	StartY = StartY + 22;
	if (pCheckMouseOver(StartX, StartY - StartYMove, SizeButtonW, SizeButtonH) == 1)
	{
		glColor3f(1.0f, 0.6742f, 0.15f);
	...
	RenderBitmap(31563, StartX, StartY - StartYMove, SizeButtonW, SizeButtonH, 0.0, 0.0, 0.64999998, 0.80000001, 1, 1, 0);
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + (SizeButtonH / 4) - StartYMove, 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[214]); //Buoc Vao
	StartY = StartY + 22;
	if (pCheckMouseOver(StartX, StartY - StartYMove, SizeButtonW, SizeButtonH) == 1)
	{
		glColor3f(1.0f, 0.6742f, 0.15f);
	...
	RenderBitmap(31563, StartX, StartY - StartYMove, SizeButtonW, SizeButtonH, 0.0, 0.0, 0.64999998, 0.80000001, 1, 1, 0);
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + (SizeButtonH / 4) - StartYMove, 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[215]); //Buoc Vao
	StartY = StartY + 22;
	...
	RenderBitmap(31563, StartX, StartY - StartYMove, SizeButtonW, SizeButtonH, 0.0, 0.0, 0.64999998, 0.80000001, 1, 1, 0);
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + (SizeButtonH / 4) - StartYMove, 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[216]);
	glColor3f(1.0f, 1.0f, 1.0f);
}
