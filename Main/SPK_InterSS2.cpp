...
//--------------------------------
	...
	//--
	SetCompleteHook(0xE9, 0x00895A48, &RenderSlotDwongradeQ);
	SetCompleteHook(0xE9, 0x00895ABD, &RenderSlotDwongradeW);
	SetCompleteHook(0xE9, 0x00895B32, &RenderSlotDwongradeE);
