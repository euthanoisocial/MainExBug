...
void SubThanMa::DrawTMPoint()
{
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX, StartY + 30 + (19.0f / 4), 0xE6FCF7FF, 0x0, 95.0f, 0, 3, gConfig.TSPK_TEXT_ENGINE[257]);
	...
	pSetBlend(false);
	gInterface.DrawFormat(eWhite, StartX - 150, 5, 150, 3, gConfig.TSPK_TEXT_ENGINE[258], this->DiemA, this->ThoiGian, this->DiemB);
	return;
}
...
#define MoveButtonToDown 0
	...
	if (pCheckMouseOver(CloseX, CloseY, 36, 36) == 1)
	{
		...
		gInterface.DrawFormat(eGold, CloseX + 15, CloseY + 30, 0, 1, gConfig.TSPK_TEXT_ENGINE[26]);
	}
	gInterface.DrawFormat(eGold, StartX + 10, gInterface.Data[TMC_MAIN].Y + 8, 210, 3, gConfig.TSPK_TEXT_ENGINE[259]);

	StartY = StartY + 45;	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[260]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[261]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontNormal, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0xFFDE26FF, 0x0, CuaSoW, 0, 1, gConfig.TSPK_TEXT_ENGINE[262]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FFCCFF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[263]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[264]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[265]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[266]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[267]);
	StartY = StartY + 12;	CustomFont.Draw(CustomFont.FontBold, StartX + (CuaSoW / 10) - 10, StartY - StartYMove, 0x00FF90FF, 0x0, CuaSoW, 0, 1,   gConfig.TSPK_TEXT_ENGINE[268]);
	StartY = StartY - 170;
	...
	CustomFont.Draw(CustomFont.FontNormal, StartX + MoveButtonToLeft, StartY + 30 + (SizeButtonH / 4), 0xE6FCF7FF, 0x0, SizeButtonW, 0, 3, gConfig.TSPK_TEXT_ENGINE[269]);
}
