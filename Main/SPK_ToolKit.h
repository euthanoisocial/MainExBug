...
class SPK_ToolKitMain
{
	...
	void RunAntiHack();
	void DrawButtonIcon(int Enum, int ImgID, float X, float Y, LPCSTR Text);
	void DrawButtonIconRank(int Enum, int ImgID, float X, float Y, LPCSTR Text);
...
extern SPK_ToolKitMain gToolKit;
